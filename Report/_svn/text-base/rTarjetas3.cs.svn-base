...
namespace T3.Report {
    ...
    public class rTarjetas3 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rTarjetas3.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrTarjetas3 : Component, ICachedReport {
        
        public CachedrTarjetas3() {
        }
