...
namespace T3
{
	...
	/// </summary>
	public class _Cls_InputBoxResult 
	{
	...
	public class _Cls_InputBox
	{
        ...
        private static _Cls_InputBoxResult _outputResponse = new _Cls_InputBoxResult();
		...
		private static void InitializeComponent()
		{
            ...
            frmInputDialog.ClientSize = new Size(398, 128);//189; 108
        ...
        static public _Cls_InputBoxResult Show(string Prompt)
		{
			InitializeComponent();
			FormPrompt = Prompt;
        ...
        static public _Cls_InputBoxResult Show(string Prompt, string Title)
		{
			InitializeComponent();
        ...
        static public _Cls_InputBoxResult Show(string Prompt, string Title, string Default)
		{
			InitializeComponent();
        ...
        static public _Cls_InputBoxResult Show(string Prompt, string Title, string Default, int XPos, int YPos)
		{
			InitializeComponent();
			FormCaption = Title;
			FormPrompt = Prompt;
        ...
        static private _Cls_InputBoxResult OutputResponse
		{
			get
			{
