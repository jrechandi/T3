...
namespace T3.Report {
    ...
    public class rPrecargac : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rPrecargac.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrPrecargac : Component, ICachedReport {
        
        public CachedrPrecargac() {
        }
