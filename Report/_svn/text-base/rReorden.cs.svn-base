...
namespace T3.Report {
    ...
    public class rReorden : ReportClass {
    ...
    public class CachedrReorden : Component, ICachedReport {
        
        public CachedrReorden() {
        }
