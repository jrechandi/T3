...
namespace T3.Report {
    ...
    public class rPrecarga : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rPrecarga.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrPrecarga : Component, ICachedReport {
        
        public CachedrPrecarga() {
        }
