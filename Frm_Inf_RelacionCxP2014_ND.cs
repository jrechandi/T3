...
namespace T3
{
    public partial class Frm_Inf_RelacionCxP2014_ND : Form
    {
        #region Atributos
        ...
        public Frm_Inf_RelacionCxP2014_ND(bool pMostrarNDP)
        {
            InitializeComponent();

            gMostrarNDP = pMostrarNDP;
        ...
        /// <summary>Muestar las notas de débito de la empresa al proveedor.</summary>
        ...
        private void mostrarNotasDebitoAlProveedor(string pGrupo, string pCompañia, string pTipo, bool pImpresa, string pDesde, string pHasta)
        {
            string sSQL;
        ...
        /// <summary>Muestra las notas de débito del proveedor.</summary>
        /// <param name="pCompañia">Compañía.</param>
        ...
        /// <param name="pTipo">Tipo de proveedor.</param>
        private void mostrarNotasDebitoDelProveedor(string pCompañia, string pProveedor, string pDesde, string pHasta, string pCategoria, string pTipo)
        {
            ...
            _Rpt_VisorReportes.ServerReport.ReportPath = CLASES._Cls_Conexion._Str_ReportPath + "Rpt_Inf_CxP_NDP";
        ...
        private void _Ctrl_Multifiltro_BotonConsultarClick(List<FiltroGrid> pFiltros)
        {
            ...
            if (gMostrarNDP)
            {
                Text = "Reporte de notas de débito al proveedor";

                mostrarNotasDebitoAlProveedor
                (
            ...
            {
                Text = "Reporte de notas de débito del proveedor";

                mostrarNotasDebitoDelProveedor
                (
                    Frm_Padre._Str_Comp,
                    sProveedor,
                    sDesde,
