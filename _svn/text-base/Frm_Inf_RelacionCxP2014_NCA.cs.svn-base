...
namespace T3
{
    public partial class Frm_Inf_RelacionCxP2014_NCA : Form
    {
        #region Atributos
        ...
        public Frm_Inf_RelacionCxP2014_NCA()
        {
            InitializeComponent();
        ...
        private void mostrarNotasCreditoAnuladas(string pGrupo, string pCompañia, string pTipo, bool pImpresa, string pDesde, string pHasta)
        {
            string sSQL;
