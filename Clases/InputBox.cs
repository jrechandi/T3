...
namespace T3
{
	...
	public class InputBox
	{
        ...
        static bool _Mtd_IsNumeric(object Expression)
        {
            bool isNum;
            double retNum;
        ...
        static void txtInput_TextChanged(object sender, EventArgs e)
        {
        ...
        static void txtInput_KeyPress(object sender, KeyPressEventArgs e)
        {
            //throw new Exception("The method or operation is not implemented.");
