...
namespace T3.Report {
    ...
    public class rPreCargaListado : ReportClass {
        
        public rPreCargaListado() {
        }
        
        public override string ResourceName {
            get {
                return "rPreCargaListado.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rPreCargaListado.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrPreCargaListado : Component, ICachedReport {
        
        public CachedrPreCargaListado() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rPreCargaListado rpt = new rPreCargaListado();
            rpt.Site = this.Site;
            return rpt;
        }
