...
namespace T3.Report {
    ...
    public class rPre_Balance : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rPre-Balance.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrPre_Balance : Component, ICachedReport {
        
        public CachedrPre_Balance() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rPre_Balance rpt = new rPre_Balance();
            rpt.Site = this.Site;
            return rpt;
        }
