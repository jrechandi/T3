...
namespace T3.Report {
    ...
    public class rCajaCxCver : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rCajaCxCver.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrCajaCxCver : Component, ICachedReport {
        
        public CachedrCajaCxCver() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rCajaCxCver rpt = new rCajaCxCver();
            rpt.Site = this.Site;
            return rpt;
        }
