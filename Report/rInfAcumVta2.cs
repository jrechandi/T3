...
namespace T3.Report {
    ...
    public class rInfAcumVta2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rInfAcumVta2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrInfAcumVta2 : Component, ICachedReport {
        
        public CachedrInfAcumVta2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rInfAcumVta2 rpt = new rInfAcumVta2();
            rpt.Site = this.Site;
            return rpt;
        }
