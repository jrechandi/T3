...
namespace T3
{
	public class Codigobarrasconssa : System.Windows.Forms.UserControl
	{
		...
		private String headerText = "Codigo De barras";
        ...
        public String _CodigoBarra_Automatico
        {
            get { return code; }
            set { code = value.ToUpper(); panel1.Refresh(); }
        }
		public int _CodigoHeight
		{
			get { return height; }
			set { height = value; panel1.Invalidate(); }
		}

		public int _LeftMargen
		{
			get { return leftMargin; }
			set { leftMargin = value; panel1.Invalidate(); }
		}

		public int _TopMargen
		{
			get { return topMargin; }
			set { topMargin = value; panel1.Invalidate(); }
		}

		public bool _MostrarNombre
		{
			get { return showHeader; }
			set { showHeader = value; panel1.Invalidate(); }
		}

		public bool _Mostrar_codigo_abajo
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Codigobarrasconssa));
			...
			this.pictureBox1.Size = new System.Drawing.Size(496, 16);
			...
			this.Name = "Codigobarrasconssa";
			this.Size = new System.Drawing.Size(496, 312);
			this.Load += new System.EventHandler(this.BarCodeCtrl_Load);
		...
		PictureBox Codigoimagen = new PictureBox ();
		Bitmap bitmap ;
		public PictureBox Image()
		{
			PictureBox este = new PictureBox();
		...
		private void BarCodeCtrl_Load(object sender, System.EventArgs e)
		{
		...
		private void panel1_Paint_1(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			for ( int i=0;i<code.Length ;i++ ) 
			{
				...
				{
					e.Graphics.DrawString("Codigo Invalido", Font, Brushes.Red, 10, 10);
					g.DrawString("Texto del Codigo Invalido", Font, Brushes.Red, 10, 10);
					return;
				}
			}
			...
			//	headerX = leftMargin;
				//footerX = leftMargin;
				headerX = ( (int)hSize.Width-((int)hSize.Width/2)) / 2;
				footerX = ( (int)hSize.Width-((int)hSize.Width/2)) / 2;
			}
