...
namespace T3.Report {
    ...
    public class rPreordCompra : ReportClass {
        
        public rPreordCompra() {
        }
        
        public override string ResourceName {
            get {
                return "rPreordCompra.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rPreordCompra.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrPreordCompra : Component, ICachedReport {
        
        public CachedrPreordCompra() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rPreordCompra rpt = new rPreordCompra();
            rpt.Site = this.Site;
            return rpt;
        }
