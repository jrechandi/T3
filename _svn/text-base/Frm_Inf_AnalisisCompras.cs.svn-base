...
namespace T3
{
    public partial class Frm_Inf_AnalisisCompras : Form
    {
        #region Atributos
        ...
        public Frm_Inf_AnalisisCompras()
        {
            InitializeComponent();
            ...
            _Ctrl_Multifiltro.agregarFiltrarPor(new FiltroCombo {
                Tipo = _Enu_MultifiltroTipos.MultifiltroTiporCaja,
                Nombre = "ccodigo", 
