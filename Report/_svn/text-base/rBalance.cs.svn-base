...
namespace T3.Report {
    ...
    public class rBalance : ReportClass {
    ...
    public class CachedrBalance : Component, ICachedReport {
        
        public CachedrBalance() {
        }
