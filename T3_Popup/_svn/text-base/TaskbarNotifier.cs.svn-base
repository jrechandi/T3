...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		public int nIncrementShow;
		public int nIncrementHide;
		...
		public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
		{
            ...
            T3_Popup.barra.sonido(@Application.StartupPath + "\\a.wav");
			//T3.barra.sonido("t3.wav");
			...
			if (nTimeToShow > 10)
			{
                ...
                nIncrementShow = T3_Popup.barra.top;//nIncrementShow+BackgroundBitmap.Height/ nEvents;
				this.Opacity=100;
			}
			else
			{
                ...
                nIncrementShow = T3_Popup.barra.top;//nIncrementShow+BackgroundBitmap.Height;
            ...
            //    //T3.barra.top=T3.barra.top-BackgroundBitmap.Height;
...
public int arriba;
	...
	//	public int pantalla;
		...
		{
			//pantalla=pantalla+BackgroundBitmap.Height;
			switch (taskbarState)
			{
