...
namespace T3.Report {
    ...
    public class rTarjetas : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "T3.Report.rTarjetas.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrTarjetas : Component, ICachedReport {
        
        public CachedrTarjetas() {
        }
